...
export default function RootLayout() {
  return <Providers><ProfileContextRouteBoundary><OrganizationContextRouteBoundary><ParentSelfServiceRouteBoundary><InactiveStaffRouteBoundary><InactiveParentRouteBoundary><BottomNavigationBackHandler><Stack initialRouteName="home" screenOptions={{ headerShown: false }}>
    ...
    {[
      "tenant-readiness", "absence-requests", "staff-leave-requests", "staff-leave-approvals", "parent-family-profile", "parent-child-profile", "pickup-authorizations", "emergency-contacts", "child-consents", "consent-definitions", "add-tenant", "institution-types", "branches", "branch-operating-hours", "overtime-charges", "global-curriculum", "global-development-programs", "goals", "development-categories", "notifications", "staff-reminders", "payment-instructions", "parent-enrollment-form", "parent-payment", "context-selection", "sign-up", "verify-phone",
