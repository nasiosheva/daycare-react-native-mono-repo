...
const bottomNavigationScreenNames = ["home", "platform-tenants", "tenant-detail", "academic", "development", "booking-approvals", "billing-admin", "staff-admin", "staff-operations", "parent-qr", "booking", "operational-hours", "parent-enrollment", "profile"];
...
export default function RootLayout() {
  return <Providers><BottomNavigationBackHandler><Stack initialRouteName="home" screenOptions={{ headerShown: false }}>{bottomNavigationScreenNames.map((name) => <Stack.Screen key={name} name={name} options={{ animation: "none"}} />)}<Stack.Screen name="add-tenant" options={{ animation: "none" }} /><Stack.Screen name="institution-types" options={{ animation: "none" }} /><Stack.Screen name="branches" options={{ animation: "none" }} /><Stack.Screen name="branch-operating-hours" options={{ animation: "none" }} /><Stack.Screen name="overtime-charges" options={{ animation: "none" }} /><Stack.Screen name="global-curriculum" options={{ animation: "none" }} /><Stack.Screen name="goals" options={{ animation: "none" }} /><Stack.Screen name="development-categories" options={{ animation: "none" }} /><Stack.Screen name="notifications" options={{ animation: "none" }} /><Stack.Screen name="staff-reminders" options={{ animation: "none" }} /><Stack.Screen name="payment-instructions" options={{ animation: "none" }} /><Stack.Screen name="parent-enrollment-form" options={{ animation: "none" }} /><Stack.Screen name="parent-payment" options={{ animation: "none" }} /><Stack.Screen name="sign-up" options={{ animation: "none" }} /></Stack></BottomNavigationBackHandler></Providers>;
}
