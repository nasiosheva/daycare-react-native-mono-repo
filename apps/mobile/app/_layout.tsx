...
export default function RootLayout() {
  return <Providers><BottomNavigationBackHandler><Stack initialRouteName="home" screenOptions={{ headerShown: false }}>{bottomNavigationScreenNames.map((name) => <Stack.Screen key={name} name={name} options={{ animation: "none"}} />)}<Stack.Screen name="institution-types" options={{ animation: "none" }} /><Stack.Screen name="branches" options={{ animation: "none" }} /><Stack.Screen name="billing-plan-editor" options={{ animation: "none" }} /><Stack.Screen name="billing-discount-editor" options={{ animation: "none" }} /><Stack.Screen name="global-curriculum" options={{ animation: "none" }} /><Stack.Screen name="goals" options={{ animation: "none" }} /><Stack.Screen name="goal-template" options={{ animation: "none" }} /><Stack.Screen name="development-categories" options={{ animation: "none" }} /><Stack.Screen name="notifications" options={{ animation: "none" }} /><Stack.Screen name="staff-reminders" options={{ animation: "none" }} /><Stack.Screen name="staff-reminder-editor" options={{ animation: "none" }} /><Stack.Screen name="parent-enrollment" options={{ animation: "none" }} /><Stack.Screen name="sign-up" options={{ animation: "none" }} /></Stack></BottomNavigationBackHandler></Providers>;
}
