...
export default function SignUpScreen() {
  ...
  return <Screen><View style={styles.content}>
    ...
    <Button loading={loading} onPress={() => void submit()}>{t("auth.createAccount")}</Button><Button variant="secondary" disabled={loading} onPress={() => router.back()}>{t("auth.signIn")}</Button>
  </View></Screen>;
}
