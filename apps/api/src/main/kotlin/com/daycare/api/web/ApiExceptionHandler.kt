...
class ApiExceptionHandler(private val messages: MessageSource) {
    ...
    private companion object {
        val errorKeys = mapOf(
            ...
            "Goal template was not found" to "error.goalTemplateNotFound", "Goal template belongs to a different organization" to "error.goalTemplateOrganization", "Global goal template cannot be modified" to "error.goalTemplateGlobalReadOnly",
