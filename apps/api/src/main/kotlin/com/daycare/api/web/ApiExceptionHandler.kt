...
class ApiExceptionHandler(private val messages: MessageSource) {
    ...
    private companion object {
        val errorKeys = mapOf(
            ...
            ParentEnrollmentError.TRANSFER_NOT_ACTIVE to "error.parentEnrollmentTransferNotActive",
            ParentEnrollmentError.TRANSFER_SAME_TENANT to "error.parentEnrollmentTransferSameTenant",
            ParentEnrollmentError.TRANSFER_ALREADY_PENDING to "error.parentEnrollmentTransferAlreadyPending",
