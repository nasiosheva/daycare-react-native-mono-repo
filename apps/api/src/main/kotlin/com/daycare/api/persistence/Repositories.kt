...
interface ChildProgramRepository : JpaRepository<ChildProgram, UUID> { fun findAllByOrganizationIdAndChildIdOrderByCreatedAtDesc(organizationId: UUID, childId: UUID): List<ChildProgram>; fun existsByIdAndOrganizationIdAndChildId(id: UUID, organizationId: UUID, childId: UUID): Boolean }
interface ChildProgramStepRepository : JpaRepository<ChildProgramStep, UUID> { fun findAllByOrganizationIdAndChildProgramIdOrderByDisplayOrderAscCreatedAtAsc(organizationId: UUID, childProgramId: UUID): List<ChildProgramStep>; fun countByChildProgramId(childProgramId: UUID): Long }
