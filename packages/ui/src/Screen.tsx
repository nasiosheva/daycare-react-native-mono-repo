...
export type ScreenProps = PropsWithChildren<{ title?: string; header?: ReactNode; footer?: ReactNode; floatingAction?: ReactNode; showAppBar?: boolean }>;

export function Screen({ children, title, header, footer, floatingAction, showAppBar }: ScreenProps) {
